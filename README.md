...
维护工作并不需要很高深的技术力和知识，可以学学基本操作之后根据当届的情况改一改excel代码再pr上去，可以用表格验算数据，把计算结果的正误反馈给我，可以贡献一些自己的实验报告,实验数据,助教给的讲义和预习题答案，也可以改进优化表格排版，具体可以做的事情写在下面的todo一栏中了，欢迎一切交流合作，fork，issue，pull request，以及小窗（qq792405142），对任何contribute在下都感激不尽。
